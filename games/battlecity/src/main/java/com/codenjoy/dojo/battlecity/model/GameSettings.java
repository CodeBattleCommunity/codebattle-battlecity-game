...
public interface GameSettings {
    ...
    Parameter<Integer> getInitialPlayerHealthCount();

    Parameter<Integer> getInitialAIHealthCount();

    Parameter<Integer> getHealthBonusLifeCycle();

    Parameter<Integer> getHealthBonusOnMap();
