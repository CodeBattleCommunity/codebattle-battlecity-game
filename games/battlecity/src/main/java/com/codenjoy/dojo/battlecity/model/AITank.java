...
public class AITank extends Tank {
    ...
    public AITank(int x, int y, Dice dice, Direction direction, int ticksPerBullet, Parameter<Integer> initialAmmo) {
        super(x, y, direction, dice, ticksPerBullet, initialAmmo);
    }
