...
public class BattlecityTest {
    ...
    public static Player player(int x1, int y1, Direction direction, EventListener listener, TankFactory playerTankFactory) {
        return new Player(listener, playerTankFactory, new PointImpl(x1, y1), direction);
    }
